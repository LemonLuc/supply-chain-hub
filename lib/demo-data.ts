...
type LocalWorkflowAction = WorkflowActionBase & {
  recipientLabel?: string;
  assigneePersona?: never;
  reviewerPersona?: never;
};

type AssignedWorkflowAction = WorkflowActionBase & {
  recipientLabel: string;
  assigneePersona: PersonaId;
  reviewerPersona?: never;
};

type ReviewWorkflowAction = WorkflowActionBase & {
  recipientLabel: string;
  assigneePersona?: never;
...
export const workflows: Record<WorkflowKey, Workflow> = {
  risks: {
    ...
    sources: [
      ...
      { id: "outlook", name: "Microsoft Outlook", category: "Microsoft 365 MCP", detail: "Draft operational follow-ups", selected: true },
    ...
    activity: [
      { tool: "SAP S/4HANA MCP", detail: "Read PO 4500872319 and material N-FK5-110-32", result: "480 blanks due 22 July", sourceIds: ["sap", "carriers"] },
    ...
    analysisTrace: [
      { label: "Understand request", detail: "Identify material, product context and requested delivery window.", outcome: "N-FK5-110-32 · CW 30" },
    ...
    summary:
      "DHL Freight shipment 00340434161094000012, containing 480 N-FK5 blanks, missed its Leipzig hub departure and is now expected on Thursday, 23 July. The smaller FedEx priority shipment remains on schedule. Current stock covers production until Thursday afternoon.",
    metrics: [
      ["Affected material", "N-FK5-110-32"],
      ["Expected arrival", "Thu, 23 Jul"],
    ...
    actions: [
      ...
      { label: "Create Microsoft Outlook recovery task", recipientLabel: "Track DHL confirmation, FedEx backup status and Oberkochen receiving cutoff with Supply Chain Hub", detail: "Track DHL confirmation, FedEx backup status and Oberkochen receiving cutoff before 12:00.", kind: "update", sourceIds: ["outlook"], allowedPersonas: ["logistics"] },
      { label: "Write Dana Narid for review", recipientLabel: "Review delivery risk summary", detail: "Send the delivery risk summary to the procurement team lead.", kind: "approval", sourceIds: ["outlook"], allowedPersonas: ["logistics"], reviewerPersona: "procurement" },
    ...
    rows: [
      {
        ...
        status: "Attention",
        evidence: "Leipzig departure missed; ETA moved from 22 to 23 July",
        sourceIds: ["carriers"],
        affectedMaterial: "480 N-FK5 optical glass blanks",
        expectedArrival: "Thu, 23 Jul",
      ...
      },
      {
        ...
        status: "On schedule",
        evidence: "Departed Frankfurt; delivery due 21 July, 10:30",
        sourceIds: ["carriers"],
        affectedMaterial: "60 N-FK5 optical glass blanks",
        expectedArrival: "Tue, 21 Jul 10:30",
  ...
  delay: {
    ...
    sources: [
      ...
      { id: "outlook", name: "Microsoft Outlook", category: "Microsoft 365 MCP", detail: "Draft supplier and team emails", selected: true },
    ...
    actions: [
      ...
      { label: "Assign recovery check to logistics", recipientLabel: "Run recovery check", detail: "Create the carrier recovery task for the logistics planner to execute.", kind: "share", allowedPersonas: ["procurement"], assigneePersona: "logistics" },
      ...
      { label: "Ask Lucia Lopez for exception review", recipientLabel: "Review six-build coverage exception", detail: "Escalate the uncovered six-build gap for C-level decision.", kind: "approval", sourceIds: ["outlook"], allowedPersonas: ["procurement"], reviewerPersona: "executive" },
    ],
    rows: [
      {
    ...
    documents: [
      {
        ...
        version: "version 26.07.17-rc3",
        lastModified: "2026-07-17 17:40 CET",
        owner: "Dana Narid",
        summary:
        ...
        recentChanges: [
          {
            timestamp: "2026-07-17 17:40 CET",
            author: "Dana Narid",
            worksheet: "Alternate Coverage",
            range: "F18:H18",
            change: "Mechatronik Süd capacity increased from 6 to 8 units and the reservation expiry moved to 20 July 12:00 CET.",
            impact: "Eight of fourteen affected Axioscan 7 builds can be protected if procurement confirms the reservation today.",
          },
          {
            timestamp: "2026-07-17 12:10 CET",
          ...
          {
            timestamp: "2026-07-16 16:05 CET",
            author: "Lukas Weber",
        ...
        rows: [
          {
            ...
            owner: "Dana Narid",
            nextReview: "2026-07-20 09:00 CET",
          },
          {
            worksheet: "Qualification Status",
            ...
            nextReview: "2026-07-24 15:00 CET",
          },
          {
            worksheet: "Production Impact",
            ...
            owner: "Lukas Weber",
            nextReview: "2026-07-20 11:30 CET",
          },
        ],
      },
    ],
  ...
  consolidate: {
    ...
    question: "Compare annual consolidation savings with strategic supplier relationships and recommend where we can consolidate safely.",
    description:
      "Combines savings potential with reliability, quality, qualification depth, continuity, and switching complexity for CLO decisions.",
    ...
    analysisTrace: [
      { label: "Understand request", detail: "Identify the portfolio scope, decision criteria and requested action.", outcome: "Savings versus relationship · consolidation" },
    ...
    heatMap: [
      {
        ...
        relationshipDrivers: [
          "Validated sterile-packaging processes",
          "98.6% on-time delivery over 24 months",
          "High regulatory switching complexity",
        ],
      },
      {
        supplier: "OptiQuartz Suhl",
        recommendation: "Keep to preserve qualified optical-glass redundancy",
        annualCostUsd: 2_800_000,
        annualSavingsUsd: 250_000,
        relationshipScore: 84,
        relationshipDrivers: [
          "Qualified optical-glass furnace capacity",
          "Low defect history on precision blanks",
          "Dual-source continuity requirement",
        ],
      },
      {
        supplier: "PräziForm Aalen",
        recommendation: "Consolidate interchangeable bracket volume",
        annualCostUsd: 1_400_000,
        annualSavingsUsd: 420_000,
        relationshipScore: 48,
        relationshipDrivers: [
          "Interchangeable approved drawings",
          "Three qualified regional sources",
          "Moderate transition effort",
        ],
      },
      {
        supplier: "Steripack Hohenlohe",
        recommendation: "Balance packaging savings against validation and continuity risk",
        targetSupplier: "MediSeal Jena",
        annualCostUsd: 3_300_000,
        annualSavingsUsd: 520_000,
        relationshipScore: 72,
        relationshipDrivers: [
          "Long-running validated packaging programs",
          "Strong service recovery performance",
          "Volume can transfer only in qualified stages",
        ],
      },
      {
        supplier: "FlexPack Esslingen",
        recommendation: "Consolidate commodity flexible-packaging volume",
        annualCostUsd: 800_000,
        annualSavingsUsd: 660_000,
        relationshipScore: 35,
        relationshipDrivers: [
          "Standard specifications with multiple alternatives",
          "Short qualification cycle",
          "Recent delivery variability",
        ],
      },
      {
        supplier: "Glaswerke Mainz",
        recommendation: "Protect strategic glass capacity while negotiating the opportunity",
        annualCostUsd: 4_600_000,
        annualSavingsUsd: 740_000,
        relationshipScore: 90,
        relationshipDrivers: [
          "Scarce qualified furnace capacity",
          "Critical optical-grade quality performance",
          "Multi-year engineering collaboration",
        ],
      },
      {
        supplier: "HelioGlass Dresden",
        recommendation: "Sequence any consolidation behind continuity safeguards",
        annualCostUsd: 2_300_000,
        annualSavingsUsd: 910_000,
        relationshipScore: 70,
        relationshipDrivers: [
          "Qualified backup for high-index glass",
          "Stable delivery and corrective-action record",
